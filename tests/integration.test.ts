...
describe("brandlyPlugin", () => {
  ...
  it("should have all required tool names", () => {
    ...
    expect(toolNames).toContain("brandly_download");
    expect(toolNames).toContain("brandly_select_provider");
    ...
    expect(toolNames).toContain("brandly_brand_kit");
